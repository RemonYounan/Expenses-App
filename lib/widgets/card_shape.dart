...
class CardShape extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path0.quadraticBezierTo(
        0, size.height * 0.3625000, 0, size.height * 0.1500000);
    path0.cubicTo(
    ...
    path0.quadraticBezierTo(size.width * 0.2854250, size.height * 0.0799500,
        size.width * 0.5000000, size.height * 0.1500000);
    path0.quadraticBezierTo(size.width * 0.7137500, size.height * 0.0783000,
        size.width * 0.7850000, size.height * 0.0500000);
    path0.cubicTo(
    ...
    path0.quadraticBezierTo(
        size.width, size.height * 0.3625000, size.width, size.height);
