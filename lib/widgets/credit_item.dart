      ...
      children: [
        ...
        AnimatedContainer(
          ...
          child: CreditCardDetails(
            type: widget.credits.creditCards[0].type!,
            name: widget.credits.creditCards[0].name!,
            number: widget.credits.creditCards[0].number!,
            pin: widget.credits.creditCards[0].pin!,
            expiryDate: widget.credits.creditCards[0].expiryDate!,
            cvv: widget.credits.creditCards[0].cvv!,
          ),
        ),
      ],
    );
